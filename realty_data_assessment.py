...
file_name_dict = {file_names[0]:['Date', 'Index Value', 'Buyer/Seller Index'],
                  file_names[1]:['Date', 'Number Available', 'Inventory Smooth, Seasonally adjusted'],
                  file_names[2]:['Date', 'Number Available', 'Median of weekly snapshot of for-sale homes within a region for a given month'],
                  file_names[3]:['Date', 'Index Value', 'Market Health Index (0 least healthy, 10 most)'],
                  file_names[4]:['Date', 'Number Sold', 'All Homes Sold'],
                  file_names[5]:['Date', 'Ratio', 'Ratio of Homes Sold as Foreclosures to All Homes'],
                  file_names[6]:['Date', '%', 'Percentage of Listings with a Price Cut during the Month'],
                  file_names[7]:['Date', '$/square foot', '3 Bedroom Median List Price Per Sq Ft'],
                  file_names[8]:['Date', '$/square foot', 'Single Family Residence Median List Price Per Sq Ft'],
                  file_names[9]:['Date', '$', 'Median Price for 3 Bedroom Homes'],
                  file_names[10]:['Date', '$', 'Median Price for Single Family Residences'],
                  file_names[11]:['Date', 'Percent (%)', 'Median of the percentage price reduction for homes with a price reduction during the month'],
                  file_names[12]:['Date', '$', 'Single Family Residence Median Sold Price Per Sq Ft'],
                  file_names[13]:['Date', '$', 'Single Family Residence Median Price Cut'],
                  file_names[14]:['Date', 'Percent (%)', 'Percentage of homes in an given region with values that have decreased in the past year'],
                  file_names[15]:['Date', 'Percent (%)', 'Percentage of homes in an given region with values that have increased in the past year'],
                  file_names[16]:['Date', 'Percent (%)', 'The percentage of current Single Family Residence listings on Zillow with a price cut during the month'],
                  file_names[17]:['Date', 'Percent (%)', 'Percent of Foreclosure Re-Sales'],
                  file_names[18]:['Date', 'Percent (%)', 'Percent Sold in Past Year (Turnover)'],
                  file_names[19]:['Date', 'Count', 'UnsoldReos_All_Homes'],
                  file_names[20]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[21]:['Date', 'ZHVI', 'Single Family Residence, ZHVI per Square Foot'],
                  file_names[22]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[23]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[24]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[25]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[26]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[27]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[28]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[29]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[30]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[31]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[32]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[33]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[34]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[35]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[36]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[37]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[38]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[39]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[40]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[41]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[42]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[43]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[44]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[45]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[46]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[47]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[48]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[49]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[50]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[51]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[52]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[53]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[54]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[55]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[56]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[57]:['Date', 'ZHVI', '3 Bedroom ZHVI'],
                  file_names[58]:['Date', 'ZHVI', '3 Bedroom ZHVI']}
...
for fname in file_names:
    ...
    if df.columns[col_count-1] != '2015-12':
        ...
        if fname[0:3] == 'Zip':
            ...
            plt.title(file_name_dict[fname][2]+df.columns[col_count-37]+' to '+df.columns[col_count-1])
